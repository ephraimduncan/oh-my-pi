	...
	families: [
		{
			...
			routing: {
				[Effort.Low]: "claude-opus-4-7-low",
				[Effort.Medium]: "claude-opus-4-7-medium",
				[Effort.High]: "claude-opus-4-7-high",
				[Effort.XHigh]: "claude-opus-4-7-xhigh",
				[Effort.Max]: "claude-opus-4-7-max",
			},
			thinking: {
				mode: "effort",
		...
		},
		{
			...
			routing: {
				[Effort.Low]: "claude-opus-4-7-low-fast",
				[Effort.Medium]: "claude-opus-4-7-medium-fast",
				[Effort.High]: "claude-opus-4-7-high-fast",
				[Effort.XHigh]: "claude-opus-4-7-xhigh-fast",
				[Effort.Max]: "claude-opus-4-7-max-fast",
			},
			thinking: {
				mode: "effort",
				efforts: [Effort.Low, Effort.Medium, Effort.High, Effort.XHigh, Effort.Max],
		...
		},
		{
			...
			routing: {
				[Effort.Low]: "claude-opus-4-8-low-fast",
				[Effort.Medium]: "claude-opus-4-8-medium-fast",
				[Effort.High]: "claude-opus-4-8-high-fast",
				[Effort.XHigh]: "claude-opus-4-8-xhigh-fast",
				[Effort.Max]: "claude-opus-4-8-max-fast",
			},
			thinking: {
				mode: "effort",
				efforts: [Effort.Low, Effort.Medium, Effort.High, Effort.XHigh, Effort.Max],
